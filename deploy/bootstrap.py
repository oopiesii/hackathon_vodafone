...
with psycopg.connect(url,autocommit=True) as conn:
    ...
    conn.execute('grant select on core.dashboard_rollup_state to ufv_processor')
    conn.execute('grant execute on function core.refresh_dashboard_rollups(),core.refresh_dashboard_rollups(bigint) to ufv_processor')
