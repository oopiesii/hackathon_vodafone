...
def grant_analyst(conn, role='ufv_analyst'):
    ...
    for statement in (
        ...
        'grant select on core.analyst_items,core.analyst_rollups,core.refresh_requests,core.analyst_receipts,core.analysis_runs,core.analyst_budget,core.analyst_state,core.ai_summaries,core.current_ai_summaries,core.analyst_summary_schedule to {}',
