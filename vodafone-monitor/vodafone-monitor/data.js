...
const mentions=[
 ...
 // city — лише коли місце події явно назване в самому матеріалі. Нема city → загальноукраїнська/без прив'язки
 // до міста тема (напр. зміна тарифів по всій мережі), а не невідома згадка про конкретне місто.
