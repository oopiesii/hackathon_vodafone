...
export const formatDate = (value: string | number | null | undefined, empty = "Невідомо") =>
  value ? toDate(value).toLocaleString("uk-UA", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit" }) : empty;

export const formatDateTime = (value: string | number | null | undefined, empty = "Невідомо") =>
  value ? toDate(value).toLocaleString("uk-UA") : empty;
