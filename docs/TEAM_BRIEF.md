...
Дата оновлення: **19.09.2026 UTC**. Підстава — розгорнутий curated-реліз із `main 581d0d7` та підготовлений код нічного потоку `feat/night-ui`. **Нічний набір WP2/WP3/WP4/WP8a/S2 ще готується до production. Виправлення ізоляції доступу розгорнуті 19.09 о 21:53 UTC.** Після релізу відповідальний за розгортання оновлює цю позначку та [STATUS.md](STATUS.md). Наявність коду, міграції чи успішного тесту не є підтвердженням розгортання.
